export default {
    ...
    reset_scrape_btn: 'Reset & Re-scrape (Reset)',
    ...
    msg_scrape_ok: 'Excellent! Background scraper engine has started.',
    msg_scrape_fail: 'Failed to trigger scraper.',
    msg_reset_scrape_ok: 'Reset successful! All tagged tracks are now back in the pending queue.',
    msg_task_started: 'Task started in background. Check "Tasks" in sidebar for progress.',
    lang_toggle: '中文',
    theme_toggle: 'Theme',
    ...
    col_size: 'Size',
    player_lyrics_error: 'Failed to load lyrics',
    tasks: {
        title: 'Task Progress & History',
        ...
        type_scan: 'Library Scan',
        type_scrape: 'Batch Scraper',
        type_download_netease: 'NetEase Download',
        type_download_qq: 'QQ Music Download',
        type_organize: 'Library Organizing',
        type_rename: 'Batch Normalize Rename',
        type_playlist_import: 'Playlist Import',
        view_logs: 'View Logs',
        cleanup: 'Cleanup History',
        cleanup_confirm: 'Clear all non-running task history?',
        close: 'Close',
        cancel: 'Terminate Task',
        cancel_confirm: 'Are you sure you want to terminate this task and all its sub-processes?',
        progress: 'Progress',
        logs: 'Logs',
        select_hint: 'Select a task to view execution details',
        child_task_hint: 'Sub-task Item'
    }
};
