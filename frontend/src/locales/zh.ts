export default {
    ...
    reset_scrape_btn: '重置并重新刮削 (Reset)',
    ...
    msg_reset_scrape_ok: '已重置成功！所有已完成曲目已回到排队状态。',
    msg_scrape_fail: '刮削触发请求失败。',
    msg_task_started: '任务已在后台启动，您可以点击左下角"任务列表"查看实时状态。',
    lang_toggle: 'English',
    theme_toggle: '色彩主题',
    theme_midnight: '午夜深蓝',
    theme_ocean: '深海之源',
    ...
    tasks: {
        ...
        type_scan: '媒体库扫描',
        type_scrape: '批量刮削',
        type_download_netease: '网易云下载',
        type_download_qq: 'QQ音乐下载',
        type_organize: '库结构调整',
        type_rename: '批量重命名',
        type_playlist_import: '歌单集群收割',
        view_logs: '查看日志',
        cleanup: '清理历史',
        cleanup_confirm: '确定要清理所有非运行中的任务记录吗？',
        close: '关闭',
        cancel: '中止任务',
        cancel_confirm: '确定要中止此任务及其所有子进程吗？',
        progress: '执行进度',
        logs: '执行日志',
        select_hint: '请选择一个任务以查看 execution 详情',
        child_task_hint: '子任务项目'
    }
};
